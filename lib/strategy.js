...
function Strategy(options, verify) {
  ...
  if (options.reqAuthMethod) {
    this._reqAuthMethod = options.reqAuthMethod;
  }
}
...
Strategy.prototype.authenticate = function(req) {
  ...
  if  ( (this._reqAuthMethod === undefined || this._reqAuthMethod === 'header') && (req.headers && req.headers.authorization) ) {
  ...
  if ( (this._reqAuthMethod === undefined || this._reqAuthMethod === 'body') && (req.body && req.body.access_token) ) {
  ...
  if ( (this._reqAuthMethod === undefined || this._reqAuthMethod === 'query') && (req.query && req.query.access_token) ) {
    if (token) { return this.fail(400); }
